    ...
    <Card className="w-full">
      <CardHeader>
        <div className="flex items-start justify-between">
          <div>
            <CardTitle className="text-xl font-bold">{theaterName}</CardTitle>
              ...
              <div className="flex gap-2 flex-wrap">
                {showtimes.map((showtime, index) => (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="text-xs px-3 py-1 hover:bg-emerald-50 hover:border-emerald-300 flex flex-col items-center h-auto"
