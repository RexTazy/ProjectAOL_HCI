...
const SearchBar = () => {
  ...
  const theaters = [
    ...
    { name: "BSD XXI", location: "Tangerang Selatan", city: "tangerang" },
    { name: "Bintaro XXI", location: "Tangerang Selatan", city: "tangerang" },
    { name: "Summarecon Serpong XXI", location: "Tangerang", city: "tangerang" },
    { name: "Living World XXI", location: "Tangerang Selatan", city: "tangerang" },
  ...
  const handleTheaterClick = (theaterName: string) => {
    // For now, navigate to theaters page
    navigate('/theaters');
    setShowResults(false);
    setSearchQuery("");
  };
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 flex items-center gap-3 px-4">
            ...
            <Input
              ...
              className="border-0 bg-transparent focus:ring-0 text-lg placeholder:text-gray-500 text-gray-800 shadow-none focus-visible:ring-0"
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 border-0"
              ...
              <div>
                ...
                <div className="space-y-2">
                  {filteredTheaters.map((theater) => (
                    <div
                      key={theater.name}
                      onClick={() => handleTheaterClick(theater.name)}
                      className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    >
