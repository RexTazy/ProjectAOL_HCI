    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
      ...
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600">Discover now playing and upcoming movies</p>
          </div>
      ...
      <div className="mb-6">
        ...
        >
          <ToggleGroupItem 
            value="now-playing" 
            className="rounded-full px-6 py-2 data-[state=on]:bg-emerald-600 data-[state=on]:text-white hover:bg-emerald-50 transition-colors"
          >
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <div className="flex-1">
          ...
          <Select value={selectedGenre} onValueChange={setSelectedGenre}>
            <SelectTrigger className="border-2 border-gray-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 rounded-xl">
