  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Discover amazing deals and exclusive offers</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {promotions.map((promotion, index) => (
          <Card 
            key={promotion.id} 
            className="overflow-hidden hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer relative"
